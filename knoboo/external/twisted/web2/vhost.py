# -*- test-case-name: knoboo.external.twisted.web2.test.test_vhost -*-
...
# Sibling Imports
from knoboo.external.twisted.web2 import resource
...
class NameVirtualHost(resource.Resource):
    ...
    def __init__(self, default=None):
        ...
        @param default: The default resource to be served when encountering an
            unknown hostname.
        @type default: L{knoboo.external.twisted.web2.iweb.IResource} or C{None}
        """
    ...
    def addHost(self, name, resrc):
        ...
        @param resrc: The L{knoboo.external.twisted.web2.iweb.IResource} to be served as the
            given hostname.
        @type resource: L{knoboo.external.twisted.web2.iweb.IResource}
        """
