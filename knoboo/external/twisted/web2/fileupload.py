...
from knoboo.external.twisted.web2.stream import IStream, FileStream, BufferedStream, readStream
from knoboo.external.twisted.web2.stream import generatorToStream, readAndDiscard
