...
from knoboo.external.twisted.web2 import twcgi, server, http, iweb
...
def readStreamToString(s):
    ...
    @param s: a L{knoboo.external.twisted.web2.stream.IByteStream} to read from.
...
class CGIDirectoryTest(CGITestBase):
    """
    Test cases for knoboo.external.twisted.web2.twcgi.CGIDirectory
    """
