...
"""
Tests for L{knoboo.external.twisted.web2.fileupload} and its different parsing functions.
"""
...
from knoboo.external.twisted.web2 import stream, fileupload
from knoboo.external.twisted.web2.http_headers import MimeType
