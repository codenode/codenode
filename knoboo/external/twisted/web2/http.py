# -*- test-case-name: knoboo.external.twisted.web2.test.test_http -*-
...
from knoboo.external.twisted.web2.stream import IByteStream
...
from knoboo.external.twisted.web2 import compat
