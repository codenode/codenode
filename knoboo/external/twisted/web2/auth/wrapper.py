# -*- test-case-name: knoboo.external.twisted.web2.test.test_httpauth -*-
...
from knoboo.external.twisted.web2.auth.interfaces import IAuthenticatedRequest
...
class HTTPAuthResource(object):
    ...
    def __init__(self, wrappedResource, credentialFactories,
                 portal, interfaces):
        """
        @param wrappedResource: A L{knoboo.external.twisted.web2.iweb.IResource} to be returned
