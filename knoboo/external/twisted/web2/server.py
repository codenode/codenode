# -*- test-case-name: knoboo.external.twisted.web2.test.test_server -*-
...
# Sibling Imports
from knoboo.external.twisted.web2 import http, iweb, fileupload, responsecode
from knoboo.external.twisted.web2 import http_headers
from knoboo.external.twisted.web2.filter.range import rangefilter
from knoboo.external.twisted.web2 import error

from knoboo.external.twisted.web2 import version as web2_version
...
def parsePOSTData(request, maxMem=100*1024, maxFields=1024,
    ...
    @type request: L{knoboo.external.twisted.web2.http.Request}.
