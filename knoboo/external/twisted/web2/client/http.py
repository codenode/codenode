# -*- test-case-name: knoboo.external.twisted.web2.test.test_client -*-
...
from knoboo.external.twisted.web2.responsecode import BAD_REQUEST, HTTP_VERSION_NOT_SUPPORTED
from knoboo.external.twisted.web2.http import parseVersion, Response
from knoboo.external.twisted.web2.http_headers import Headers
from knoboo.external.twisted.web2.stream import ProducerStream, StreamProducer, IByteStream
from knoboo.external.twisted.web2.channel.http import HTTPParser, PERSIST_NO_PIPELINE, PERSIST_PIPELINE
from knoboo.external.twisted.web2.client.interfaces import IHTTPClientManager
...
class ClientRequest(object):
    ...
    def __init__(self, method, uri, headers, stream):
        ...
        @type headers: C{dict}, L{knoboo.external.twisted.web2.http_headers.Headers}, or
            C{None}

        @param stream: Content body to send to the remote HTTP server.
        @type stream: L{knoboo.external.twisted.web2.stream.IByteStream}
        """
...
class HTTPClientProtocol(LineReceiver, TimeoutMixin, object):
    ...
    def submitRequest(self, request, closeAfter=True):
        ...
        @return: A Deferred which will be called back with the
            L{knoboo.external.twisted.web2.http.Response} from the server.
        """
