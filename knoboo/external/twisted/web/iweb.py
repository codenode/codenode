...
"""
Interface definitions for L{knoboo.external.twisted.web}.
"""
...
class IRequest(Interface):
    ...
    def addCookie(k, v, expires=None, domain=None, path=None, max_age=None, comment=None, secure=None):
        ...
        L{knoboo.external.twisted.web.server.Request.getSession} and the
        L{knoboo.external.twisted.web.server.Session} class for details.
        """
...
class ICredentialFactory(Interface):
    ...
    def getChallenge(request):
        ...
        @type peer: L{knoboo.external.twisted.web.http.Request}
    ...
    def decode(response, request):
        ...
        @type request: L{knoboo.external.twisted.web.http.Request}
