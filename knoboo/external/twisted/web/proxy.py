# -*- test-case-name: knoboo.external.twisted.web.test.test_proxy -*-
...
from knoboo.external.twisted.web.resource import Resource
from knoboo.external.twisted.web.server import NOT_DONE_YET
from knoboo.external.twisted.web.http import HTTPClient, Request, HTTPChannel
