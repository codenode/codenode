# -*- test-case-name: knoboo.external.twisted.web.test.test_soap -*-
# Copyright (c) 2001-2004 Twisted Matrix Laboratories.
# See LICENSE for details.


"""
SOAP support for knoboo.external.twisted.web.
...
# twisted imports
from knoboo.external.twisted.web import server, resource, client
