...
# Twisted Imports
from knoboo.external.twisted.web import server, static, twcgi, script, demo, distrib, wsgi
...
demo webserver that has the Test class from knoboo.external.twisted.web.demo in it."""
    ...
    def opt_path(self, path):
        ...
        """
        def trp(*args, **kwargs):
            # Help avoid actually importing knoboo.external.twisted.web.trp until it is really
            # needed.  This avoids getting a deprecation warning if you're not
            # using deprecated functionality.
            from knoboo.external.twisted.web import trp
...
def makePersonalServerFactory(site):
    ...
    @type site: L{knoboo.external.twisted.web.server.Site}
