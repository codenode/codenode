# -*- test-case-name: knoboo.external.twisted.web.test.test_http -*-
...
This is used by knoboo.external.twisted.web.
...
from knoboo.external.twisted.web.http_headers import _DictHeaders, Headers
...
class Request:
    ...
    def addCookie(self, k, v, expires=None, domain=None, path=None, max_age=None, comment=None, secure=None):
        ...
        knoboo.external.twisted.web.server.Request.getSession and the
        knoboo.external.twisted.web.server.Session class for details.
        """
        cookie = '%s=%s' % (k, v)
