...
from knoboo.external.twisted.web import http, resource, server, html, static
from knoboo.external.twisted.web.http_headers import Headers
...
<html>
    <head>
    <title>knoboo.external.twisted.web.distrib.UserDirectory</title>
    <style>
    ...
    <body>
    <h1>knoboo.external.twisted.web.distrib.UserDirectory</h1>
