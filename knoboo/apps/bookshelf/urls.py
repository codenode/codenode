...
from apps.bookshelf.views import bookshelf, folders
from apps.bookshelf.views import load_bookshelf_data, change_notebook_location
from apps.bookshelf.views import empty_trash, new_notebook
