...
from codenode.external.twisted.web import http, resource, server, html, static
from codenode.external.twisted.web.http_headers import Headers
...
<html>
    <head>
    <title>codenode.external.twisted.web.distrib.UserDirectory</title>
    <style>
    ...
    <body>
    <h1>codenode.external.twisted.web.distrib.UserDirectory</h1>
