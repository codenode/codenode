# -*- test-case-name: codenode.external.twisted.web.test.test_soap -*-
# Copyright (c) 2001-2004 Twisted Matrix Laboratories.
# See LICENSE for details.


"""
SOAP support for codenode.external.twisted.web.
...
# twisted imports
from codenode.external.twisted.web import server, resource, client
