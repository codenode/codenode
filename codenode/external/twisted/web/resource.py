# -*- test-case-name: codenode.external.twisted.web.test.test_web -*-
...
class Resource:
    ...
    def getChild(self, path, request):
        ...
        @param request: a codenode.external.twisted.web.server.Request specifying meta-information
    ...
    def render(self, request):
        ...
        codenode.external.twisted.web.server.NOT_DONE_YET, in which case it is this
        ...
        if not m:
            ...
            # below three error resources in codenode.external.twisted.web.error are removed.
            from codenode.external.twisted.web.error import UnsupportedMethod
