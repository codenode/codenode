...
"""
Exception definitions for L{codenode.external.twisted.web}.
"""

import operator, warnings

from codenode.external.twisted.web import http
...
from codenode.external.twisted.web import resource as _resource

class ErrorPage(_resource.ErrorPage):
    """
    Deprecated alias for L{codenode.external.twisted.web.resource.ErrorPage}.
    """
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "codenode.external.twisted.web.error.ErrorPage is deprecated since Twisted 9.0.  "
            "See codenode.external.twisted.web.resource.ErrorPage.", DeprecationWarning,
            stacklevel=2)
...
class NoResource(_resource.NoResource):
    """
    Deprecated alias for L{codenode.external.twisted.web.resource.NoResource}.
    """
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "codenode.external.twisted.web.error.NoResource is deprecated since Twisted 9.0.  "
            "See codenode.external.twisted.web.resource.NoResource.", DeprecationWarning,
            stacklevel=2)
...
class ForbiddenResource(_resource.ForbiddenResource):
    """
    Deprecated alias for L{codenode.external.twisted.web.resource.ForbiddenResource}.
    """
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "codenode.external.twisted.web.error.ForbiddenResource is deprecated since Twisted "
            "9.0.  See codenode.external.twisted.web.resource.ForbiddenResource.",
