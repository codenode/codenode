# -*- test-case-name: codenode.external.twisted.web.test.test_http -*-
...
This is used by codenode.external.twisted.web.
...
from codenode.external.twisted.web.http_headers import _DictHeaders, Headers
...
class Request:
    ...
    def addCookie(self, k, v, expires=None, domain=None, path=None, max_age=None, comment=None, secure=None):
        ...
        codenode.external.twisted.web.server.Request.getSession and the
        codenode.external.twisted.web.server.Session class for details.
        """
        cookie = '%s=%s' % (k, v)
