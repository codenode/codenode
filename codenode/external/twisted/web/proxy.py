# -*- test-case-name: codenode.external.twisted.web.test.test_proxy -*-
...
from codenode.external.twisted.web.resource import Resource
from codenode.external.twisted.web.server import NOT_DONE_YET
from codenode.external.twisted.web.http import HTTPClient, Request, HTTPChannel
